...
|Turbo Whisper uses evdev for Wayland hotkeys. Ensure your user can read `/dev/input/event*` (add to `input` group and relogin). Also check for shortcut conflicts in KDE/GNOME settings.
