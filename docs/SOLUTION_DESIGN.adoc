...
Turbo Whisper uses **pynput** for global hotkeys on X11/macOS/Windows and **evdev** for Wayland on Linux. Wayland falls back to xdg-desktop-portal only when evdev is unavailable.
